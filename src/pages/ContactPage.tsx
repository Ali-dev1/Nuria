        ...
        <div className="space-y-12">
          ...
          <div className="space-y-8">
            <div className="flex gap-6 items-start group">
              <div className="w-14 h-14 rounded-2xl bg-secondary/5 flex items-center justify-center shrink-0 border border-secondary/10 group-hover:bg-secondary/10 transition-colors">
                <MapPin className="w-6 h-6 text-secondary" />
              </div>
              <div className="space-y-2">
                <p className="font-sans font-bold text-foreground text-lg">Our Location</p>
            ...
            <div className="flex gap-6 items-start group">
              <div className="w-14 h-14 rounded-2xl bg-primary/5 flex items-center justify-center shrink-0 border border-primary/10 group-hover:bg-primary/10 transition-colors">
                <Phone className="w-6 h-6 text-primary" />
              </div>
              <div className="space-y-2">
                <p className="font-sans font-bold text-foreground text-lg">Support Lines</p>
                <p className="font-sans text-muted-foreground text-lg">0794 233261 / 0724 670194</p>
              </div>
            </div>
            ...
            <div className="flex gap-6 items-start group">
              ...
              <div className="space-y-2">
                <p className="font-sans font-bold text-foreground text-lg">Email Us</p>
                <p className="font-sans text-muted-foreground">nuriakenyabookstore@gmail.com</p>
              </div>
            </div>
            ...
            <div className="flex gap-6 items-start group">
              ...
              <div className="space-y-2">
                <p className="font-sans font-bold text-foreground text-lg">Open Hours</p>
                <p className="font-sans text-muted-foreground leading-relaxed">
          ...
          <a 
            ...
            className="inline-flex w-full items-center justify-center gap-3 bg-green-500 text-white py-5 rounded-2xl font-bold uppercase tracking-widest hover:brightness-95 transition-all shadow-xl shadow-green-500/20"
          >
        ...
        <div className="space-y-12">
          ...
          <div className="bg-white p-10 lg:p-14 rounded-[3rem] border border-border shadow-2xl shadow-black/5">
            ...
            <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
              <div className="grid sm:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <input 
                    ...
                    className="w-full px-6 py-4 bg-background border-2 border-transparent rounded-2xl focus:border-primary/10 focus:bg-white transition-all text-sm outline-none" 
                    required 
                  />
                </div>
                <div className="space-y-2">
              ...
              <div className="space-y-2">
                <label htmlFor="contact-subject" className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground ml-1">Subject</label>
                <input 
                  id="contact-subject"
                  type="text" 
              ...
              <div className="space-y-2">
                ...
                <textarea 
                  ...
                  className="w-full px-6 py-4 bg-background border-2 border-transparent rounded-2xl focus:border-primary/10 focus:bg-white transition-all text-sm outline-none resize-none"
                ></textarea>
              </div>
              <Button className="w-full py-8 bg-primary text-white font-sans font-bold rounded-2xl hover:bg-primary/90 transition-all shadow-xl shadow-primary/10 text-xs tracking-[0.2em] uppercase">
