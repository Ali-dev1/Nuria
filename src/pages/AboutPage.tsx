  ...
  return (
    ...
    >
      <div className="space-y-24">
        ...
        {/* 🏔️ Core Values */}
        <section className="bg-white rounded-[4rem] p-12 lg:p-20 border border-[#E5E0D8]">
          <div className="text-center mb-16">
            <h2 className="font-display text-4xl font-bold text-[#1A1A1A]">Our Core Values</h2>
            <p className="mt-4 font-sans text-[#6B7280] text-lg">The principles that guide every decision we make.</p>
          </div>
