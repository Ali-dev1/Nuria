    ...
    <div className="min-h-screen bg-background flex items-center justify-center py-20 px-4">
      <div className="w-full max-w-md space-y-10">
        <div className="text-center">
          ...
          <h1 className="font-display text-2xl font-bold text-foreground mt-10">Login</h1>
          <p className="font-sans text-sm text-muted-foreground mt-2 leading-relaxed">Sign in to continue to your bookshelf.</p>
        </div>


        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            <label htmlFor="login-email" className="block font-sans text-[13px] font-medium text-foreground mb-1.5">Email</label>
            <input id="login-email" type="email" value={email} onChange={(e) => setEmail(e.target.value)} required className="w-full px-4 py-3 border border-border rounded-lg text-sm bg-white font-sans focus:outline-none focus:ring-2 focus:ring-primary/30" placeholder="you@example.com" />
          </div>
          <div>
            <label htmlFor="login-password" className="block font-sans text-[13px] font-medium text-foreground mb-1.5">Password</label>
