      ...
      <td className="px-8 py-6">
        <div className="flex items-center gap-5">
          <div className="relative">
            {p.images?.[0] ? (
              <img src={p.images[0]} alt="" className="w-14 h-14 rounded-2xl object-cover border border-border shadow-sm group-hover:scale-110 transition-transform duration-500" />
            ) : (
